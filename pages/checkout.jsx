            ...
            <section>
              ...
              <fieldset class="mb-3 bg-white shadow-lg rounded text-gray-600">
                <label class="flex border-b border-gray-200 h-12 py-3 items-center">
                  ...
                  <input name="card" class="focus:outline-none px-3 w-full" placeholder="Card Number" required="" />
                </label>
                <label class="inline-flex w-2/4 border-gray-200 py-3">
                    <span class="text-right px-2">Expiry</span>
                    <input name="state" class="focus:outline-none px-3" placeholder="MM/YY" />
                  </label>
                  <label class="xl:w-1/4 xl:inline-flex py-3 items-center flex xl:border-none border-t border-gray-200 py-3">
                    <span class="text-right px-2 xl:px-0 xl:text-none">CVV</span>
                    <input name="postal_code" class="focus:outline-none px-3" placeholder="701" />
                  </label>
              </fieldset>
            </section>
          </div>
          <button class="submit-button px-4 py-3 rounded-full bg-accent text-white focus:ring focus:outline-none w-full text-xl font-semibold transition-colors">
            Pay €846.98
          </button>
        </div>
        <div class="col-span-1 bg-white lg:block hidden">
          ...
          <ul class="py-6 border-b space-y-6 px-8">
            <li class="grid grid-cols-6 gap-2 border-b-1">
              <div class="col-span-1 self-center">
                <Image src="https://bit.ly/3oW8yej" alt="Product" class="rounded w-full" />
              </div>
              ...
              <div class="col-span-2 pt-3">
                <div class="flex items-center space-x-2 text-sm justify-between">
                  ...
                  <span class="text-accent font-semibold inline-block">€61.98</span>
                </div>
              </div>
            </li>
            <li class="grid grid-cols-6 gap-2 border-b-1">
              <div class="col-span-1 self-center">
                <Image src="https://bit.ly/3lCyoSx" alt="Product" class="rounded w-full" />
              </div>
              <div class="flex flex-col col-span-3 pt-2">
              ...
              <div class="col-span-2 pt-3">
                <div class="flex items-center space-x-2 text-sm justify-between">
                  ...
                  <span class="text-accent font-semibold inline-block">€785</span>
                </div>
              </div>
            </li>
          </ul>
          <div class="px-8 border-b">
            <div class="flex justify-between py-4 text-gray-600">
              <span>Subtotal</span>
              <span class="font-semibold text-accent">€846.98</span>
            </div>
            <div class="flex justify-between py-4 text-gray-600">
              <span>Shipping</span>
              <span class="font-semibold text-accent">Free</span>
            </div>
          </div>
